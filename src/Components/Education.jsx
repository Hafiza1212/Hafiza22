...
<div className="second w-[50%] rounded-[20px] mt-[30px] mx-[15px] border-r-4   border-b-4 border-red-500 bg-[#F4F4F4] font-normal">
                                ...
                                <h6 className='px-[38px] pb-[18px] pt-[5px] font-bold text-[18px] lineHeight-[26px]'>2008-2012</h6>
                                <p className='px-[38px] pb-[48px] text-[#5D6570]'>Each project here showcases my commitment to excellence and
adaptability, tailored to meet each client’s unique needs a personal.</p>
...
<div className="pl-[40px] pr-[148px] pb-[32px]">
<h6 className='font-medium text-[16px] text-[#FF494A]'>experience</h6>
<h1 className='text-[24px] font-bold font-rajdhani'>Fatima Asrafy</h1>
<h5 className='mt-[6px] text-[18px] font-medium font-rajdhani text-[#141414]'>UI/UX Designer</h5>
<p className='text-[#5D6570] mt-[16px] font-normal'>Duis aute irure dolor in reprehenderit in voluptate velit esse
...
<div className="pl-[40px] pr-[148px] ">
<h6 className='font-medium text-[16px] text-[#FF494A]'>experience</h6>
<h1 className='text-[24px] font-bold font-rajdhani'>Fatima Asrafy</h1>
<h5 className='mt-[6px] text-[18px] font-medium font-rajdhani text-[#141414]'>UI/UX Designer</h5>
<p className='text-[#5D6570] mt-[16px] font-normal'>Interested in working together? Let’s bring your ideas to
life! Contact me, and let’s start building something.</p>
